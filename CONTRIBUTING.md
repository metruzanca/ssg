...
2. Clone your fork: `git clone https://github.com/metruzanca/ssg.git`
3. Navigate to the project directory: `cd ssg`
...
If you have any questions, please [open an issue](https://github.com/metruzanca/ssg/issues/new) for discussion.
