...
The site index's Frontmatter can have additional properties for side wide configuration.

| Property      | Value        | Derscription                                                                       |
| ------------- | ------------ | ---------------------------------------------------------------------------------- |
| domain        | string       | the site's domain name e.g. `zanca.dev` needed for this like social preview        |
